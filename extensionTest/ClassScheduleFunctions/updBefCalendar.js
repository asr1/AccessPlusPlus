//Hopefully you're ready for a completely "hacky" extension - seriously don't judge ヽ（´ー｀）┌
//Ignore the random portuguese var names
...
function cssEntry(backGColor, prof, nome){
		...
		return '<tr> <td> <div style = "display:table; padding-left: 40px;margin-left: 0px; color:#b5d333;'+ txtShadow+ '">' + '<br>' + prof + ' </td> <td> <br><a style = "padding-left: 100px; text-decoration: none; color: white;' + txtShadow + '" href= "http://www.ratemyprofessors.com/search.jsp?query=' + nome + '+Iowa+State+University'+'"> Check me out!</a> <br><br> </td></div></tr>';		
...
$(document).ready(function() {
	...
	if (url == accessPlus || url == accessPlus1){
		...
		//checkValues(classInfoArr.sDate, false);
		...
		document.getElementById("expBtn").addEventListener("click", function(){alert("Hey")});
		element.append("<br>");	
	}
